        ...
        <>
            ...
            >
                <div className="container navbar-content flex items-center justify-between">
                    ...
                    >
                        <div className="w-10 h-10 bg-white flex items-center justify-center border-2 border-white group-hover:bg-transparent group-hover:text-white transition-colors">
                            <span className="text-2xl text-black group-hover:text-white transition-colors">♟</span>
                        </div>
