...
export const ChessStatsGrid = ({ personalInfo }) => {
    return (
        <div className="chess-stats-wrapper">
            <div className="chess-stats-row">
                ...
                <a href={personalInfo.social.github} target="_blank" rel="noopener noreferrer" className="chess-stat-entry">
                    ...
                    <div className="chess-stat-details">
                        ...
                        <div className="stat-block">
                            <div className="chess-stat-main">{personalInfo.stats.github.repos}</div>
            ...
            {/* GitHub Heatmap Box in Light Theme */}
            <div className="chess-github-heatmap-card">
                <div className="chess-github-heatmap-header">
                    <span className="chess-heatmap-label">GitHub Contribution Activity</span>
                    <a 
                        href={personalInfo.social.github || "https://github.com/vixxk"} 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="chess-heatmap-user"
                    >
                        @vixxk
                    </a>
                </div>
                <GitHubHeatmap username="vixxk" theme="chess" />
            </div>
        </div>
    );
};
